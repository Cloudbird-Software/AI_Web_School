...
集成重编号：原 0018（d-line 分支从 0016 拉出，跳过 0017）；
合并入主干时 0017~0020 已被 score_run/item_lifecycle/spec_table/passage 占用，
故重编号为 0021，down_revision 改为 '0020'（passage）以保持线性链。
"""
