...
集成重编号：原 0018（c-line 分支从 task/T-W4-ai-bus head=0016 拉出，down=0016）；
合并入主干时 0017/0018/0019 已被 score_run/item_lifecycle/spec_table 占用，
故重编号为 0020，down_revision 改为 '0019'（spec_table）以保持线性链。
"""
