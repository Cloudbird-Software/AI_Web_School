...
集成重编号：原 0019（d-line 分支 down_revision='0018' 指 blueprint）；
合并入主干后 blueprint 已重编号为 0021，故本迁移重编号为 0022，
down_revision 改为 '0021'（blueprint）以保持线性链。
"""
...
def _create_triggers() -> None:
    ...
    binding = op.get_bind()
    # #43 Major 修复：不重定义 0005 已统一的 raise_append_only_error（同 0017/0021），
    # 只挂触发器。
